...
```{r cluster_1500, eval=F}

#  nlibrary(doParallel) # For parallelization
...
Once we have a final design, we can recommend evaluation its performance using simulation, as done in Dupont et al. (2020).